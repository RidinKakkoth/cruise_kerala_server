...
const { partnerSignUp, partnerSignin,resetPass, getPartnerData,getBookings, updateProfilePic,updateProfile, proofUpload,emailValid } = require("../controllers/partnerController");
